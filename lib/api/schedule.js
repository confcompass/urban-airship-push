...
ScheduleApi.prototype.update = function (id, pushData, callback) {
    var options = {
        path: REST_ENDPOINTS.SCHEDULED_PUSH + '/' + id,
        method: 'PUT',
...
ScheduleApi.prototype.delete = function (id, callback) {
    var options = {
        path: REST_ENDPOINTS.SCHEDULED_PUSH + '/' + id,
        method: 'DELETE',
        expectedStatusCode: HTTP_RESPONSE_CODES.NO_CONTENT.CODE,
        useMasterAuth: true,
        auth: this.accessConfiguration
    };
    urbanAirshipConnection.sendRequest(options, {}, callback);
};
